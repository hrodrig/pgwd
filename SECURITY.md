...
We support the **latest release** and the current development branch with security updates. We use [semantic versioning](https://semver.org/) (MAJOR.MINOR.PATCH).
...
- **Preferred:** Use [GitHub Security Advisories](https://github.com/hrodrig/pgwd/security/advisories/new) (click "Report a vulnerability") so the report is private.
- **Alternatively:** Email the maintainer (see profile at [github.com/hrodrig](https://github.com/hrodrig)) with a clear description, steps to reproduce, and impact.
