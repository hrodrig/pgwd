...
1. Match **DISTFILES** (e.g. **`pgwd_v1.0.1_openbsd_amd64.tar.gz`** after **`gmake port-openbsd-sync`**).
...
4. **Option B — `file://`:**
   ...
   ```sh
   cp /path/to/pgwd/dist/pgwd_v1.0.1_openbsd_amd64.tar.gz /tmp/pgwd-dist/
   cd /usr/ports/sysutils/pgwd
